        ...
        <Container>
          <Row className="header-box d-flex align-items-center">
            <Col lg="6" >
              ...
              <p className='mb-4'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nostrum velit voluptate consectetur reprehenderit vero labore?</p>
        ...
        <Container>
          <Row>
            <Col>
              ...
              <p className="text-center">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Optio necessitatibus ipsa a doloribus reiciendis sit.</p>
            </Col>
          </Row>
          <Row>
